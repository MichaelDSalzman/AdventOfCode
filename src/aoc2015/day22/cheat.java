...
public class cheat {
    ...
    private static int solve(boolean hard) {
        ...
        wizards.add(new Wizard(50, 500, parseBoss()));
        int counter = 0;
    ...
    private static int[] parseBoss() {
        return new int[]{71, 10};
        // int[] boss = new int[2];
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Part One = " + solve(false));
        System.out.println(System.currentTimeMillis() - start);
        start = System.currentTimeMillis();
        System.out.println("Part Two = " + solve(true));
        System.out.println(System.currentTimeMillis() - start);
    }
}
